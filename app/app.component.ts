...
@Component({
  ...
  template: `<style>
    ...
    <p class="score_board" >xигрок1 <img src="zhizn1.svg">{{player_figures[0].live_count}} oчки:{{player_figures[0].total_scores}}</p>
    <p *ngIf="!local_one_player || server_game" class="score_board" >игрок2 <img src="zhizn1.svg">{{player_figures[1].live_count}} oчки:{{player_figures[1].total_scores}}</p>
...
export class AppComponent {
  ...
  server_game: boolean = false;//true
  ...
  local_one_player: boolean = false;
  ...
  constructor(public el: ElementRef, public renderer: Renderer, private server_interaction: server_interaction) {
    ...
    */
    ...
    //this.player_figures[0].man_play_figure.movement_type = 'joystick';

    //this.player_figures[0].man_play_figure.keyset =new player_keyset(39, 37, 40, 38, 32); // new player_keyset(68,65,88,69,90);// 
    this.player_figures[0].man_play_figure.keyset = new player_keyset(68, 65, 88, 69, 90);
    this.player_figures[0].gamepad = true;
    ...
    this.meteor_play_figures[3].image_sources = [{ step_px: 5, width: 60, length: 35, event: 'move', source: 'inik.svg', live_iter: 25, iteration_count: 0, active_heigth: null }, { step_px: 5, width: 60, length: 35, event: 'move', source: 'inik2.svg', live_iter: 25, iteration_count: 0, active_heigth: null }, { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 2, iteration_count: 0, active_heigth: null }];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[7].image_sources = [{ step_px: 12, width: 124, length: 88, event: 'move', source: 'zhizn.svg', live_iter: 15, iteration_count: 0, active_heigth: null }
    ...
    this.meteor_play_figures[10].image_sources = [{ step_px: 10, width: 60, length: 35, event: 'move', source: 'inoplanetjanin.svg', live_iter: 25, iteration_count: 0, active_heigth: null }, { step_px: 25, width: 60, length: 35, event: 'move', source: 'inoplanetjanin1.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 25, width: 60, length: 35, event: 'move', source: 'inoplanetjanin2.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 10, width: 60, length: 35, event: 'move', source: 'inoplanetjanin3.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 25, width: 60, length: 35, event: 'move', source: 'inoplanetjanin4.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 10, width: 60, length: 35, event: 'move', source: 'inoplanetjanin5.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 5, iteration_count: 0, active_heigth: null }
      , { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 2, iteration_count: 0, active_heigth: null }
    ];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[15].image_sources = [{ step_px: 7, width: 35, length: 70, event: 'move', source: 'treug0.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px:  7, width: 35, length: 150, event: 'move', source: 'treug.svg', live_iter: 5, iteration_count: 0, active_heigth: null }
      , { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 2, iteration_count: 0, active_heigth: null }
    ];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[16].image_sources = [{ step_px: 12, width: 35, length: 70, event: 'move', source: 'treug0.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 12, width: 35, length: 150, event: 'move', source: 'treug.svg', live_iter: 5, iteration_count: 0, active_heigth: null }, { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 2, iteration_count: 0, active_heigth: null }
    ];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[18].image_sources = [{ step_px: 12, width: 70, length: 70, event: 'move', source: 'laser_large.svg', live_iter: 15, iteration_count: 0, active_heigth: null }];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[19].image_sources = [{ step_px: 10, width: 87, length: 33, event: 'move', source: 'dvagalaza.svg', live_iter: 25, iteration_count: 0, active_heigth: null }, { step_px: 10, width: 87, length: 73, event: 'move', source: 'dvagalaza2.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 3, iteration_count: 0, active_heigth: null }];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    this.meteor_play_figures[20].image_sources = [{ step_px: 10, width: 60, length: 35, event: 'move', source: 'inik.svg', live_iter: 25, iteration_count: 0, active_heigth: null }, { step_px: 10, width: 60, length: 35, event: 'move', source: 'inik2.svg', live_iter: 15, iteration_count: 0, active_heigth: null }, { step_px: 0, width: 60, length: 35, event: 'disappear', source: 'vrag_vzriv.svg', live_iter: 2, iteration_count: 0, active_heigth: null }];
    //,{width: 40, length: 40, event:'move' , source: 'star_white.svg', live_iter:5, iteration_count:0 }
    ...
    if (this.local_one_player && this.server_game === false) {
    ...
    if (this.local_one_player === false) {
      //this.player_figures[1].man_play_figure.visibility='hidden';
      this.server_game = false;
      this.generate_figure_ind();
      this.input_form_visibility = 'hidden';
      //setInterval(() => { this.my_main(); }, 50);
      window.requestAnimationFrame(() => { this.my_main() });
  ...
  newGame() {
    ...
    if (this.server_game) {
      ...
      console.log(this.server_operation);
  ...
  my_main(): void {
    ...
    //this.move_active_objects(this.step_counter, 15, 3);
    this.step_counter++;
    window.requestAnimationFrame(() => { this.move_active_objects(this.step_counter, 15, 3) });
  }
